...
이 문서는 willog-saas 프로젝트의 Git 워크플로우, 브랜치 전략, 커밋 메시지 규칙을 정의합니다.
...
willog-saas는 **단일 `main` 브랜치**를 기반으로 운영하는 Trunk-Based Development 모델을 사용합니다.
...
willog-saas는 **Conventional Commits** 사양을 따릅니다. 이는 버전 관리 자동화, 변경사항 추적, 릴리스 노트 생성을 용이하게 합니다.
