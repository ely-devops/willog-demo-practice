// RemoveRedEye icon - Figma: data-name="remove_red_eye" (Material Design filled)
const DeviceEyeIcon = ({ className = 'w-4 h-4' }: { className?: string }) => (
